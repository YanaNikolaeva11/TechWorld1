...
<form  action='<c:url value="/registration" />' method="post"  >
    <div class="container">
        ...
        <%--<p><a href="basket.html" class="signin" name="SignIn">Sign in</a></p>--%>
        <%--<form action="/signin"><p><input type="submit" name="signin" href="basket.html" class="signin" value="Sign In"></p></form>--%>
        <%--<p><a href="basket.html" class="registration"  name="Registration">Registration</a></p>--%>
        <%--<p><input type="submit" name="registration" href="user.html" class="registration" value="Registration"></p>--%>
        <p><input type="submit" name="registration" class="registration" value="Registration"></p>
    </div>
</form>
