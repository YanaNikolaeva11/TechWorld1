...
<body>
    ...
    <div  class="buttons">
        <a href="signin.jsp" class="buttons-signin"> Sign in </a>
        <a href="registration.jsp" class="registration"> Registration</a>
    </div>
    <div class="text">TechWorld</div>
    <%--<div class="buttons">
      <p><a href="user.jsp"  class="user">CategoryProduct</a></p>
     &lt;%&ndash; <p><a name="Action" class="action">Action</a></p>&ndash;%&gt;
    </div>--%>
